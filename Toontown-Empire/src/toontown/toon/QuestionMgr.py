...
class _CleverbotSession(ChatterBotSession):
    ...
    def think_thought(self, thought):
        ...
        self.vars['tteLocMP3'] = _utils_string_at_index(response_values, 13)
        self.vars['tteLocTXT'] = _utils_string_at_index(response_values, 14)
        self.vars['tteLocTXT3'] = _utils_string_at_index(response_values, 15)
        self.vars['tteText'] = _utils_string_at_index(response_values, 16)
