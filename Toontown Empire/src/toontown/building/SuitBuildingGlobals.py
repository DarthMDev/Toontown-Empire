...
buildingMinMax = {
    ...
    ToontownGlobals.RockAByeRoad: [config.GetInt('bedtime-boulevard-building-min', 6),
...
buildingChance = {
    ...
    ToontownGlobals.RockAByeRoad: config.GetFloat('bedtime-boulevard-building-chance', 100.0),
    ToontownGlobals.SellbotHQ: 0.0,
    ToontownGlobals.SellbotFactoryExt: 0.0,
    ToontownGlobals.CashbotHQ: 0.0,
    ToontownGlobals.LawbotHQ: 0.0,
