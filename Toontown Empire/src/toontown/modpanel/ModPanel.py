...
class ModPanel(NodePath, DirectObject):
    def __init__(self):
        ...
        button = self.create_button('New Button', self.load_create_button_dialog)
    ...
    def load_create_button_dialog(self):
        ...
        self.current_accept_button = self.create_button('Make Button', self.create_button_complete)
