...
parser.add_argument('--server-ver', default='TTE-1.0',
...
parser.add_argument('--resources-dir', default='../resources',
                    help='The directory of the Toontown Empire resources.')
parser.add_argument('--config-dir', default='../dependencies/config/release',
                    help='The directory of the Toontown Empire configuration files.')
...
parser.add_argument('modules', nargs='*', default=['otp', 'toontown', 'dependencies', 'user', 'pymongo', 'bson'],
...
# Copy the provided Toontown Empire modules:
...
configData = []
with open('../dependencies/config/general.prc') as f:
