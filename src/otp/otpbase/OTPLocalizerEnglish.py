...
SuitFaceoffTaunts = {'b': ['Do you have a donation for me?',
 ...
 'm1': ["You'll make me a Made Man.",
        "It's time to take out the trash.",
        "It's never wise to mess with a Soldier."],
 'm2': ["Ah, I was just about to call my Soldiers.",
        "Allow me to capo this off.",
        "This is just the capo the iceberg.",
        "You're about to be eliminated."],
 'm3': ["Would you like a consultation?",
        "Do you have an appointment?",
        "I'd advise you to run.",
        "Hello, I'll be your grief counselor today."],
 'm4': ["Go ahead, make me!",
        "This ought to make my day.",
        "Next up on How It's Made: Made Men.",
        "You'll help me make it in this world."],
 'm5': ["You better keep your distance.",
        "Those're some nice Laff points. Wouldn't it be a shame if something happened to them?",
        "You can do it my way, or you can go back to the Playground.",
        "Wouldn't it be sad if all your Gags were suddenly taken?"],
 'm6': ["I know just how to beat you.",
        'A wise man once said, "Don\'t fight enemies you can\'t beat."',
        "If you were wise, you'd click 'RUN'."],
 'm7': ["I am the maker of demise.",
        "I make the dooms of Toons.",
        "Time to make your escape."],
 'm8': ["Time to execute you.",
        "Don cross my path.",
        "Hurry up, they are not. cooperating.",
        "Don you think I'm powerful?"]}
