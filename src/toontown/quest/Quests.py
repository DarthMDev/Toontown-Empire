...
class Quest:
    ...
    @staticmethod
    def getNumQuestItems():
        return -1

    @staticmethod
    def addArticle(num, oString):
        if len(oString) == 0:
            return oString
        if num == 1:
            return oString
    ...
    @staticmethod
    def doesCogCount(avId, cogDict, zoneId):
        return 0

    @staticmethod
    def doesFactoryCount(avId, location):
        return 0

    @staticmethod
    def doesMintCount(avId, location):
        return 0

    @staticmethod
    def doesCogPartCount(avId, location):
        return 0

    @staticmethod
    def getCompletionStatus(av, questDesc, npc = None):
...
class TexturedQuest:
    @staticmethod
    def getModelFromTexture(texture):
...
# TODO: Organize this in a better way than going down. ~FordTheWriter
QuestDict = {
...
def getVisitingQuest():
    return VisitQuest(VISIT_QUEST_ID, QUEST)
